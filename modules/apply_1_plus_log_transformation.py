...
def apply_1_plus_log_transformation(data, columns_to_transform):
    ...
    ValueError
        If any column in columns_to_transform is not
        in the DataFrame or contains non-numeric data.
    """
...
def main():
    ...
    ------
    SystemExit
        If the command-line arguments are invalid or
    ...
    parser.add_argument(
        "columns", nargs='+', type=str,
        help="Columns to apply the log(1 + x) transformation to."
    )
    parser.add_argument(
