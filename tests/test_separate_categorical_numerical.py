...
from modules.separate_categorical_numerical import (
    separate_categorical_numerical, main
)


class TestSeparateCategoricalNumerical(unittest.TestCase):
    """
    Test case for the separate_categorical_numerical
    function and main function.

    This class contains various test methods to ensure
    the correct functionality of the separate_categorical_numerical
    function and main function under different scenarios,
    ...
    def test_unrecognized_dtype(self, mock_stdout):
        ...
        numerical_cols = separate_categorical_numerical(data)
        self.assertEqual(set(numerical_cols), {'A', 'C'})
        self.assertIn("Column 'B' has an unrecognized data type",
    ...
    def test_main_function(self):
        ...
        with open(temp_num_name, 'r', encoding='utf-8') as f:
