...
class TestHyperparameterTuning(unittest.TestCase):
    ...
    of the hyperparameter_tuning function under different scenarios, including
    ...
    def test_tuning_single_model(self):
        ...
        best_models, best_params = hyperparameter_tuning(models, param_grids, self.X, self.y)
        
        self.assertIn('RandomForest', best_models)
        self.assertIn('RandomForest', best_params)
        self.assertIsInstance(best_models['RandomForest'], RandomForestRegressor)
    ...
    def test_invalid_model(self):
        """
        Test handling of an invalid model that doesn't implement the scikit-learn estimator interface.
        """
        class InvalidModel:
            def fit(self, X, y):
                pass
